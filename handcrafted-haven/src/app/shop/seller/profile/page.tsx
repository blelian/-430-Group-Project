...
function SellerProfilePageContent() {
  ...
  useEffect(() => {
    async function loadSeller() {
      try {
        // Later, replace with logged-in seller ID from token or cookies
